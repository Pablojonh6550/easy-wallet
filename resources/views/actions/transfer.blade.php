...
@section('title', 'Easy Wallet | Transferir')
                        ...
                        <div class="card-body p-3">
                            ...
                            <div>
                                <div id="deposit-form">
                                    ...
                                    <div class="mb-3">
                                        <input type="number" class="form-control" placeholder="Digite o número da conta"
                                            id="account" required min="0" inputmode="numeric" onwheel="this.blur()"
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const modalAccountInput = document.getElementById('modal-account');
            ...
            depositBtn.addEventListener('click', function() {
                ...
                modalAccountInput.value = accountInput.value;
